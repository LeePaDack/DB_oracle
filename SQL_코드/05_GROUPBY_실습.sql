...
/**** HAVING 실습 ****/
-- 1. 각 부서별 평균 급여가 400 만원 이상한 부서 조회
...
-- 5. EMPLOYEE 테이블에서
-- 부서별 70 년대 생의 급여 평균이 300만 이상인 부서를 조회하고
-- 부서코드 오름차순 정렬
-- FLOOR (AVG(AS 급여평균
